...
return a}function F(a){var b=a;if(a.alternate)for(;b.return;)b=b.return;else{a=b;do{b=a;if(0!==(b.effectTag&1026))return 1;a=b.return}while(a)}return 3===b.tag?2:3}function G(a){if(2!==F(a))throw l(Error(188));}function P(a){var b=a.alternate;if(!b){b=F(a);if(3===b)throw l(Error(188));return 1===b?null:a}for(var c=a,e=b;;){var d=c.return;if(null===d)break;var h=d.alternate;if(null===h){e=d.return;if(null!==e){c=e;continue}break}if(d.child===h.child){for(h=d.child;h;){if(h===c)return G(d),a;if(h===
